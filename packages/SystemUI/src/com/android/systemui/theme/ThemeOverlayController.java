...
public class ThemeOverlayController extends CoreStartable implements Dumpable {
    ...
    protected static final String OVERLAY_SYSTEM_BLACK_THEME =
    ...
    public void start() {
        ...
        mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SYSTEM_BLACK_THEME),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
    ...
    private void updateThemeOverlays() {
        ...
        boolean isBlackMode = (Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.SYSTEM_BLACK_THEME,
                0, currentUser) == 1) && isNightMode();
        if (categoryToPackage.containsKey(OVERLAY_CATEGORY_SYSTEM_PALETTE) && isBlackMode) {
            OverlayIdentifier blackTheme = new OverlayIdentifier(OVERLAY_SYSTEM_BLACK_THEME);
